...
module.exports = {
    ...
    //update: (userId, roomId, joinTime, leaveTime) => db.query(`call update_join_history(${userId},${roomId},${joinTime},${leaveTime})`),
    update_leave_time: (userId, roomId, leaveTime) => db.query(`call update_join_history_leave_time("${userId}","${roomId}","${leaveTime}")`),
